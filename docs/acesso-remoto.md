...
- a GUI **lê** o token de `HKCU\Environment` na abertura e o envia nos testes; ela **não gera nem grava** o token para você. Configurar o motor é papel do motor.
